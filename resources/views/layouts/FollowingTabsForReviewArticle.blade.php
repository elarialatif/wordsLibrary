...
<table class="stepbar-progress">
    <tbody>
    <tr>
        <td class="step-item step-item-first @if(request()->url()==url('reviewer/view/article/'.$article->list_id.'/'.$article->level.'/'.'0'.'/'.'0') ) pending   @endif" data-step="1">
            <a href="{{url('reviewer/view/article/'.$article->list_id.'/'.$article->level.'/'.'0'.'/'.'0')}}" >
        ...
        <td class="step-item step-item-middle  @if(request()->url()==url('reviewer/view/article/'.$article->list_id.'/'.$article->level.'/'.'1'.'/'.'1')) pending @endif" data-step="2">
            <a href="{{url('reviewer/view/article/'.$article->list_id.'/'.$article->level.'/'.'1'.'/'.'1')}}">
                        <span class="step-body">
                           <span> مقال موسع </span>
                        </span>
            </a>
        ...
        <td class="step-item step-item-last  @if(request()->url()==url('reviewer/viewVocabsForArticle/'.$article->list_id.'/'.$article->level)) pending @endif" data-step="3">
            <a href="{{url('reviewer/viewVocabsForArticle/'.$article->list_id.'/'.$article->level)}}">
                        <span class="step-body">
