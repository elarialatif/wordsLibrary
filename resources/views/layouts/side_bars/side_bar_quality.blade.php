        ...
        <div class="navbar-content sidenav-horizontal" id="layout-sidenav">
            <ul class="nav pcoded-inner-navbar sidenav-inner">
                ...
                <li class="nav-item {{request()->is("quality")?"active":""}}">
                    <a href="{{url('quality')}}" class="nav-link">
                        <span class="pcoded-micon"><i class="mdi mdi-file"></i></span>
                        <span class="pcoded-mtext">مواضيع جديده </span></a>
                </li>
                <li class="nav-item {{request()->is("quality/myList")?"active":""}}">
                    <a href="{{url('quality/myList')}}" class="nav-link">
                        <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                        <span class="pcoded-mtext">مواضيعى </span></a>
                </li>
                <li class="nav-item {{request()->is("quality/resend")?"active":""}}">
                    <a href="{{url('quality/resend')}}" class="nav-link">
                        <span class="pcoded-micon"><i class="feather icon-home"></i></span>
