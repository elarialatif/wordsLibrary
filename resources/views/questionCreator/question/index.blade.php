                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if(auth()->user()->role==\App\Helper\UsersTypes::QuestionReviewer)
                                                                            <a href="{{url('questionReviewer/review/'.$articalEasy->id)}}" class="btn btn-info">السهل<i class="fa fa-plus"></i></a>
                                                                            <a href="{{url('questionReviewer/review/'.$articalNormal->id)}}" class="btn btn-info">المتوسط<i class="fa fa-plus"></i></a>
                                                                            <a href="{{url('questionReviewer/review/'.$articalHard->id)}}" class="btn btn-info">الصعب<i class="fa fa-plus"></i></a>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            @endforeach
