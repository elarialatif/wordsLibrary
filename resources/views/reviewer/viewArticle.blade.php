                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                @else
                                <a href="" style="float: left;font-weight: bold;color: #0d71bb" class="btn btn-success">تمت
                                    المراجعة بنجاح</a>
                                @endif
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <input type="hidden" name="field_id" value="{{$article->id}}">
                                ...
                                <div class="table-responsive">
                                    <table id="key-act-button"
                                        ...
                                        <tr @if($issue->step==\App\Helper\IssuesSteps::CloseByCreator)
                                            ...
                                            <td>{{$issue->title}}</td>
                                            <td>
                                                <a data-toggle="modal" data-target="#exampleModal{{$issue->id}}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{url('issues/chang/step/'.$issue->id.'/'.\App\Helper\IssuesSteps::Open)}}"
                                                               type="button" class="btn btn-danger">اعادة الى المحرر</a>
                                                        </div>
