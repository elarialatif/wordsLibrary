                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @endif
                                    <a href="{{url('quality/'.$page)}}" class="btn btn-dark"
                                    ...
                                    left: -25px;top: 3;width: 4px;height: 20px;">
                                            ...
                                            <div id="Issues">
                                                <div class="table-responsive">
                                                    @php
                                                        $issue=\App\Models\Issues::where(['field_id'=>$artical->id,'type'=>'Normal','table'=>'article','user_id'=>auth()->id()])->get();@endphp
                                                    @if($issue->count()>0)
                                                        <table
                                                    ...
                                                    <h6 style="font-size: 20px">الصوت
                                                        ...
                                                        <div class="modal fade" id="soundModal{{$sound->id}}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">إضافة ملاحظة
                                                                            للصوت</h5>
...
<<<<<<< HEAD
                                                                            ...
                                                                            <textarea name="name" rows="6" cols="55"> </textarea>
=======
                                                                            <label><h4>الملاحظة</h4></label>
                                                                            <textarea name="name" rows="6" cols="60"> </textarea>
>>>>>>> 19fb3f10aba858869013e68b3b45b6a29200c402
                                                                            <input type="hidden" name="field_id" value="{{$sound->id}}">
                                                                            <input type="hidden" name="table" value="sound">
                                                                            <br>
                                                                            <br>
                                                                            <button type="submit" class="btn btn-success"> إضافة
                                                                            </button>
                                                                        </form>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                    ...
                                                    @if($sound)
                                                        ...
                                                        <div id="Issues">
                                                            <div class="table-responsive">
                                                                @php
                                                                    $issue=\App\Models\Issues::where(['field_id'=>$sound->id,'table'=>'sound','user_id'=>auth()->id()])->get();@endphp
                                                                @if($issue->count()>0)
                                                                    <table
                                                                            class="display table nowrap table-striped table-hover"
                                                                            style="width:100%">
                                    ...
                                    left: -25px;top: 3;width: 4px;height: 20px;">
                                                    ...
                                                    <h6 style="font-size: 20px">الصوت
                                                        ...
                                                        {{--class="btn btn-icon btn-outline-info radbor"><i class="fas fa-edit"></i></a>--}}
                                                        {{--model for add Issuses for Sound--}}
                                                        <div class="modal fade" id="soundModal{{$soundStretch->id}}" tabindex="-1"
                                                             role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="{{url('issues/create')}}" method="post">
                                                                            ...
                                                                            <input type="hidden" name="field_id" value="{{$soundStretch->id}}">
                                                                            <input type="hidden" name="table" value="sound">
                                                                            <br>
                                                                            <br>
                                                                            <button type="submit" class="btn btn-success"> إضافة
                                                    ...
                                                    @if($soundStretch)
                                                        ...
                                                        <div id="Issues">
                                                            <div class="table-responsive">
                                                                @php
                                                                    $issue=\App\Models\Issues::where(['field_id'=>$soundStretch->id,'table'=>'sound','user_id'=>auth()->id()])->get();@endphp
                                                                @if($issue->count()>0)
                                                                    <table
                                                                            class="display table nowrap table-striped table-hover"
                                                                            style="width:100%">
