                                        ...
                                        <table id="key-act-button"
                                            ...
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target="#editModal{{$user->id}}"  class="btn btn-icon btn-outline-info radbor"> <i class="fa fa-edit"></i></a>
                                                        <a href="{{url('users/delete')}}/{{$user->id}}"  class="btn btn-icon btn-outline-danger radbor"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                {{--model for edit user--}}
