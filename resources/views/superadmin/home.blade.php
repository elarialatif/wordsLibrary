                        ...
                        <div class="card-block">
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col">
                                    ...
                                    <h5 class="m-0">عدد المقالات الاصلية التى تم رفعها للموضوعات</h5>
                                </div>
                                <div class="col-auto">
                                    <label class="label theme-bg text-white f-14 f-w-400 float-right">{{$allLists-$fileUnderUploading}}</label>
                                </div>
                            </div>
                            <div class="row align-items-center justify-content-center">
                                <div class="col">
                                    <i class="mdi mdi-file-upload f-30 text-c-blue"></i>
                                    <h5 class="m-0">عدد المقالات التى تم رفعها بالمستويات الثلاثة</h5>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="tab-pane fade active show" id="day">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link user active" data-toggle="tab" role="tab" href="#daysub1"
                                               onclick="Rates({{\App\Helper\UsersTypes::LISTMAKER}})"
                                               id="{{\App\Helper\UsersTypes::LISTMAKER}}">معد مواضيع</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="nested-content">
                                        <div class="tab-pane fade active in show" data-toggle="tab">
                                            <div class="media">
                                                <div class="media-body">

                                                <table class="" id="daysub1" >
                                                </table>
                    ...
                    <div class="card statistial-visit">
                        ...
                        <div class="card-block">
                            ...
                            <div class="media mt-4 article_media">
                                ...
                                <div class="media-body">
                                    <label class="label theme-bg text-white f-14">{{$fileUnderUploading}} -- {{($allLists)?round(($fileUnderUploading/$allLists)*100):0}}
                                        %</label>
                                </div>
                            </div>
                            <div class="media mt-4 article_media">
                                <div class="photo-table">
                                    <h6>مقالات تحت التحليل</h6>
                                    <div class="progress">
                                ...
                                <div class="media-body">
                                    <label class="label theme-bg2 text-white f-14">{{$fileUnderAnalizing}} -- {{($allLists)?round(($fileUnderAnalizing/$allLists)*100):0}}
                                        %</label>
                                </div>
                            </div>
                            <div class="media mt-4 article_media">
                                <div class="photo-table">
                                    <h6>مقالات تم تحليلها</h6>
                                    <div class="progress">
                                ...
                                <div class="media-body">
                                    <label class="label bg-c-blue text-white f-14 ">{{$analizingFile}} -- {{($allLists)?round(($analizingFile/$allLists)*100):0}}
                                        %</label>
                                </div>
                            </div>
                        </div>
