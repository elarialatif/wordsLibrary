...
@section('content')
    ...
    <!-- ####################################################### -->
    @php
        $StretchArticle=str_replace('div','p',$article->stretchArticle);
        $NormalArticle=str_replace('div','p',$article->article);
            $arrOfStretchArticle=  explode("<!-- pagebreak -->",$StretchArticle);

            $arrOfNormalArticle=  explode("<!-- pagebreak -->",$NormalArticle);
    @endphp
    <div class="container">
        <!-- Row 1 -->
        <div class="row">
                        ...
                        <div class="card-header">
                            <h4>
                                ...
                                <a class="btn btn-primary"
                                   @if(auth()->user()->role==\App\Helper\UsersTypes::SUPERADMIN || auth()->user()->role==\App\Helper\UsersTypes::ADMIN) href="{{url('allFiles')}}"
                                   @else href="{{url('userArchive')}}" @endif
                    ...
                    <div class="row content">
                        ...
                        <div class="col-xl-7 col-md-7 m-b-30 right">
                            ...
                            <ul class="nav nav-tabs" id="myTab1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link  active show" id="user-tab" data-toggle="tab" href="#5a"
                                       role="tab" aria-selected="false">
                                        <h3>السؤال القبلي</h3>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="user-tab" data-toggle="tab" href="#1a" role="tab"
                                       aria-selected="false">
                                        <h3>المقال</h3>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="designer-tab" data-toggle="tab" href="#2a" role="tab"
                                       aria-selected="false">
                                        <h3>الأنشطة</h3>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="user-tab" data-toggle="tab" href="#6a" role="tab"
                                       aria-selected="false">
                                        <h3>السؤال البعدي</h3>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Developer-tab" data-toggle="tab" href="#3a" role="tab"
                                       aria-selected="true">
                                        <h3>المقال الموسع</h3>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Developer-tab" data-toggle="tab" href="#4a" role="tab"
                                       aria-selected="true">
                                ...
                                <div class="tab-pane fade active show" id="5a" role="tabpanel">
                                    <div class="media friendlist-box align-items-center justify-content-center m-b-20">
                                        <div class="media-body">
                                            ...
                                            <div id="tinymcFont">  {!! $article->pollHint !!}
                                            <p> {!! $article->poll !!} </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div id="tinymcFont">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    @for($i=0;$i<count($arrOfNormalArticle);$i++)
                                                        <li><a @if($i==0) class="active show" @endif   data-toggle="tab"
                                                               href="#content{{$i}}">{{$i+1}}</a></li>
                                                    @endfor
                                                </ul>
                                                <div class="tab-content">
                                                    @for($i=0;$i<count($arrOfNormalArticle);$i++)
                                                        <div id="content{{$i}}"
                                                             class="tab-pane fade @if($i==0) in active show @endif">
                                                            {!! $arrOfNormalArticle[$i] !!}
                                                        </div>
                                                    @endfor
                                ...
                                <div class="tab-pane fade" id="3a" role="tabpanel">
                                    <div class="media friendlist-box align-items-center justify-content-center m-b-20">
                                        <div class="media-body">
                                            ...
                                            <div id="tinymcFont">
                                                <ul class="nav nav-tabs">
                                                    @for($i=0;$i<count($arrOfStretchArticle);$i++)
                                                        <li ><a @if($i==0) class="active show" @endif data-toggle="tab"
                                                                                               href="#StretchContent{{$i}}">{{$i+1}}</a>
                                                        </li>
                                                    @endfor
                                                </ul>
                                                <div class="tab-content">
                                                    @for($i=0;$i<count($arrOfStretchArticle);$i++)
                                                        <div id="StretchContent{{$i}}"
                                                             class="tab-pane fade @if($i==0) in active show @endif">
                                                            {!! $arrOfStretchArticle[$i] !!}
                                                        </div>
                                                    @endfor
                        ...
                        <div class="col-xl-5 col-md-5 m-b-30 left">
                            ...
                            @if(auth()->user()->role==\App\Helper\UsersTypes::SUPERADMIN || auth()->user()->role==\App\Helper\UsersTypes::ADMIN)
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::ANALYZING_FILE.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                ...
                                <div id="levelsModal2" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::INSERTING_ARTICLE.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div id="levelsModal3" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::REVIEW_ARTICLE.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div id="levelsModal6" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::Languestic.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div id="levelsModal7" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::Sound.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div id="levelsModal8" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::Quality.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div id="levelsModal9" class="modalDetails modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        onclick="location.href='{{url('adminChangeStepOfList/'.\App\Helper\Steps::Publish.'/'.$list->id)}}'"
                                                        type="button">
                                                    موافق
                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                ...
                                <div class="row team">
                                    <h3>فريق العمل</h3>
                                    <div>
                                        <a class="btn btn-primary m-t-5" data-toggle="collapse" href="#collapseExample"
                                           role="button" aria-expanded="true"
                                           aria-controls="collapseExample">المعدين</a>
                                    </div>
                                    <!-- Collapse -->
