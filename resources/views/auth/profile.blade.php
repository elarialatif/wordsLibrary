                ...
                <div class="container">
                    <div class="profile-img">
                        ...
                        <div class="row" id="foo" >
                            <div id="btnclicked1" style="display:none;"><img id="av1" src="{{asset('public/images/user/1.jpg')}}" alt="Image" class="img-responsive"></div>
                            <div id="btnclicked2" style="display:none;"><img id="av2" src="{{asset('public/images/user/2.jpg')}}" alt="Image" class="img-responsive"></div>
                            <div id="btnclicked3" style="display:none;"><img id="av3" src="{{asset('public/images/user/3.jpg')}}" alt="Image" class="img-responsive"></div>
                            <div id="btnclicked4" style="display:none;"><img id="av4" src="{{asset('public/images/user/4.jpg')}}" alt="Image" class="img-responsive"></div>
                            <div id="btnclicked5" style="display:none;"><img id="av5" src="{{asset('public/images/user/5.jpg')}}" alt="Image" class="img-responsive"></div>
                        </div>
                        ...
                        <form action="{{url('profile')}}/{{$user->id}}"  method="post" class="form-horizontal" role="form">
                           ...
                           {{csrf_field()}}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$user->name}}" id="exampleInputFirstName" aria-describedby="emailHelp">
                                {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                            </div>

                               <div class="form-group col-md-6">
                                  <label style="display: flex" for="exampleInputEmail1">البريد الألكتروني</label>
                                  <input type="email" class="form-control" name="email" value="{{$user->email}}" id="exampleInputEmail1" aria-describedby="emailHelp" disabled>
                                  {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                               </div>
                            </div>
                            <div class="row">
                           ...
                           <div class="modal-footer">
                              ...
                              <button aria-label="Close" type="button" class="btn btn-secondary" data-dismiss="modal" pd-popup-close="popupNew">غلق
                              </button>
                           </div>
                        </form>
                    </div>
