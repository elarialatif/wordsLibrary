    ...
    setTimeout(function () {
        ...
        $(document).ready(function () {
            $('#dt-live-dom').DataTable({
                "columns": [null, {"orderDataType": "dom-text-numeric"}, {
        ...
        $('#dt-http').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "dt-json-data/scripts/server-processing.php", data: function (d) {
                    d.myKey = "myValue";
                }
            },
            "columns": [{"data": "first_name"}, {"data": "last_name"}, {"data": "position"}, {"data": "office"}, {"data": "start_date"}, {"data": "salary"}]
        ...
        $('#dt-orthogonal').DataTable({
            ...
            columns: [{data: "name"}, {data: "position"}, {data: "office"}, {data: "extn"}, {
                data: {
        ...
        $('#lang-file').DataTable({"language": {"url": "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/German.json"}});
