...
(function ($) {
  ...
  var settings = {
    readonly: false,
    limitCount: Infinity,
    input: '<input type="text" maxLength="20" placeholder="بحث">',
    data: [],
    searchable: true,
  ...
  function selectToDiv(str) {
    ...
    result = result.replace(/<optgroup[^>]*>/gi, function (matcher) {
      ...
      return '<li style="padding: 7px;color: #0062cc;" class="dropdown-group" data-group-id="' + (groupId ? groupId[1] : '') + '">' + (groupName ? groupName[1] : '') + '</li>';
    });
